	...
	class A_guru extends CI_Controller	{
		...
		public function insert(){
			...
			if($this->form_validation->run()==false){
				...
				$this->session->set_flashdata('nuptk', form_error('NUPTK','<p class="text-danger col-md-auto">','</p>'));
				...
				$this->session->set_flashdata('JK', form_error('JK','<p class="text-danger col-md-auto">','</p>'));
				$this->session->set_flashdata('mapel', form_error('mapel','<p class="text-danger col-md-auto">','</p>'));
				$this->session->set_flashdata('status', form_error('status','<p class="text-danger col-md-auto">','</p>'));
