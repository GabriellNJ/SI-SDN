...
<head>
    ...
    <title>Pengumuman | SDN 2 Sidorejo</title>
</head>
                ...
                <div class="row justify-content-center align-content-center">
                    <div class="col-md-9 col-lg-7">
                        <div class="section-heading text-center mb-4">
                            <h5 class="h6 text-primary">Pengumuman</h5>
                            <h2>Pengumuman Kegiatan SDN 2 Sidorejo</h2>
                        </div>
                    </div>
                </div>
                <div class="tab-content" id="nav-tabContent-2">
                                ...
                                <div class="row">
                                 <?php
                                    ...
                                    <div class="col-md-6 col-lg-12 mb-4">
                                        <div class="card-program border border-2 bg-white rounded-custom">
                                            <div class="position-relative connected-app-content">
                                                ...
                                                <div class="rpk-desc">
                                                    <div class="h4 text-decoration-none d-block mb-1 limit-10-line-text"><?= $judul ?></div>
                                                    ...
                                                    <div class="avatar-info">
                                                        ...
                                                        <span class="small fw-medium text-muted"><?= $tanggal ?></span>
                                                    </div>
                                                    </div>
                                                    </div>
                        ...
                        <!-- <div class="row justify-content-center align-items-center mt-5 mb-5">
                            <div class="col-auto my-1">
                                <a href="#" class="btn btn-soft-primary btn-sm">Sebelumnya</a>
                            </div>
                            <div class="col-auto my-1">
                                <nav>
                            ...
                            <div class="col-auto my-1">
                                <a href="#" class="btn btn-soft-primary btn-sm">Selanjutnya</a>
                            </div>
                        </div> -->
                        <!-- Pagination End -->
                    </div>
