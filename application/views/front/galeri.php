...
<head>
    ...
    <title>Galeri | SDN 2 Sidorejo</title>
</head>
<body>
    <!-- Preloader Start -->
    <div id="preloader">
                ...
                <div class="row justify-content-center align-content-center">
                    <div class="col-md-10 col-lg-8">
                        <div class="section-heading text-center mb-4">
                            <h5 class="h6 text-primary">Galeri</h5>
                            <h2>Galeri Kegiatan SDN 2 Sidorejo</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="tab-content" id="nav-tabContent-2">
                            <div class="tab-pane fade pt-60 active show">
                                <div class="row">
                                    <?php
                                        $no=0;
                                        foreach ($data as $i) :
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-4">
                                        <div class="card-program border border-2 bg-white rounded-custom" style="height:100%">
                                            <div class="position-relative connected-app-content">
                                                <img class="img-fluid img-program rounded-custom mb-4" src="<?php echo base_url()?>asset/foto/galeri/<?= $gambar?>" alt="<?= $judul ?>" style="height:300px">
                                                <!-- <a class="h6 text-decoration-none" href="program-detail.html"><?= $judul ?></a> -->
