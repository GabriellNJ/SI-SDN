...
(function ($) {
    ...
    function setLanguage(lang) {
        ...
        if(lang=='eng') {
            document.getElementById("header-lang-img").src=BASEURL+"assets/images/flags/us.jpg";
        } else if(lang=='sp') {
            document.getElementById("header-lang-img").src=BASEURL+"assets/images/flags/spain.jpg";
        }
        else if(lang=='gr') {
            document.getElementById("header-lang-img").src=BASEURL+"assets/images/flags/germany.jpg";
        }
        else if(lang=='it') {
            document.getElementById("header-lang-img").src=BASEURL+"assets/images/flags/italy.jpg";
        }
        else if(lang=='ru') {
            document.getElementById("header-lang-img").src=BASEURL+"assets/images/flags/russia.jpg";
        }
    ...
    function getLanguage() {
        ...
        $.getJSON(BASEURL+'assets/lang/' + language + '.json', function(lang) {
